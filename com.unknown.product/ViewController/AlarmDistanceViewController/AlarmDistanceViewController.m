...
@interface AlarmDistanceViewController ()
...
@implementation AlarmDistanceViewController
...
+ (instancetype)buildViewController {
    ...
    id result = [storyboard instantiateViewControllerWithIdentifier:@"AlarmDistanceViewController"];
    return result;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlarmDistanceCell" forIndexPath:indexPath];
